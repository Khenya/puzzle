...
if __name__ == '__main__':
    ...
    while True:
        ...
        # Filtrar las detecciones para mantener solo aquellas con un puntaje (score) alto
        high_confidence_boxes = boxes[scores > 0.8]  # Aquí 0.8 es un ejemplo de umbral de confianza
